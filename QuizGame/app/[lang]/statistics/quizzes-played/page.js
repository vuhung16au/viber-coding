...
export default function QuizzesPlayedPage({ params }) {
  const { lang } = params;
    ...
    <div className="container mx-auto px-4 py-8">
      ...
      <div className="bg-gray-800 p-6 rounded-lg shadow-md mb-10">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
          <Link href={`/${lang}/statistics/quizzes-played/total`} className="bg-gray-700 hover:bg-gray-600 p-4 rounded-lg transition">
            {t('allTime')}
          </Link>
          <Link href={`/${lang}/statistics/quizzes-played/last-30-days`} className="bg-gray-700 hover:bg-gray-600 p-4 rounded-lg transition">
            {t('last30Days')}
          </Link>
          <Link href={`/${lang}/statistics/quizzes-played/last-7-days`} className="bg-gray-700 hover:bg-gray-600 p-4 rounded-lg transition">
            {t('last7Days')}
          </Link>
