...
export default function QuizzesCreatedPage({ params }) {
  const { lang } = params;
  ...
  return (
    <div className="container mx-auto px-4 py-8">
      ...
      <p className="text-gray-400 mb-8">{t('allTimeStatistics')}</p>
      ...
      <div className="bg-gray-800 p-6 rounded-lg shadow-md mb-10">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
          <Link href={`/${lang}/statistics/quizzes-created/total`} className="bg-gray-700 hover:bg-gray-600 p-4 rounded-lg transition">
            {t('allTime')}
          </Link>
          ...
          <Link href={`/${lang}/statistics/quizzes-created/last-24-hours`} className="bg-gray-700 hover:bg-gray-600 p-4 rounded-lg transition">
            {t('last24Hours')}
          </Link>
        </div>
      </div>
